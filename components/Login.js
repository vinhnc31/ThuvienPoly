      ...
      <ImageBackground source={BackgoundLogin} style={{ width: widthSrc, height: '100%' }}>
        <View style={styles.container}>
          <View style={{ backgroundColor: '#fff', paddingHorizontal: 32, }}>
            <Text style={{ fontSize: 24, fontStyle: 'normal', color: '#FC6011', alignItems: 'flex-start', marginTop: 16 }}>Đăng nhập</Text>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('NavBar')} style={styles.button}>
